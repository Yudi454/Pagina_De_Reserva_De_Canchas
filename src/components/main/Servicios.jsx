  ...
  return (
      <>
       <div className="container text-center my-5">
        <br />
        <h2 className='title-servicios'>Características Clave de nuestros servicios</h2>
        <br />
      <p className='informacion'>"nombre de la web" te brinda una plataforma integral para llevar tu experiencia deportiva al siguiente nivel. Ya sea que estés buscando el lugar perfecto para un partido amistoso, estamos aquí para vos. Descubí cómo nuestras características únicas pueden mejorar tu experiencia deportiva.</p>
      <br />
      <br />
        ...
        <div className="col-md-4 mb-4">
          <div className="card servicio-card h-100">
            <div className="card-body">
              ...
              <p className="card-text">Contamos con espacio de estacionamiento sin costo adicional.</p>
            </div>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card servicio-card h-100">
            <div className="card-body">
              ...
              <p className="card-text">Áreas cómodas e higiénicas para cambiarte y asearte.</p>
            </div>
          </div>
        </div>
        <div className="col-md-4 mb-4">
          <div className="card servicio-card h-100">
            <div className="card-body">
              ...
              <p className="card-text">Amplia variedad de snacks y bebidas disponibles.</p>
            </div>
          </div>
        </div>
      </div>
